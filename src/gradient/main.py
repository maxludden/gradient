...
class Gradient(Text):
    ...
    def named_gradient_example(
        ...
        console.print('[dim i]Named gradients are graidents that have user \
specified colors[/]', justify="center")
        if save:
            console.save_svg(
                path, title="MaxGradient",
    ...
    def random_gradient_example(
        ...
        console.print("[i dim]Random gradients are randomly generated by \
gradient automatically.[/]", justify="center")
        console.line()
        if save:
    ...
    def rainbow_gradient_example(
        ...
        console.print("[dim i]Rainbow gradients are also automated and will randomly\
span a gradient from one point on the spectrum (randomly) all the way around \
until it returns to it's starting color.", justify="center")
        console.line(1)
        if save:
