...
DEFAULT_STYLES: dict[str, StyleType] = {
    ...
    "hotpink": Style(color="#ff00af", bold=True),
    "bold.hotpink": Style(color="#ff00af", bold=True),
    "repr.hotpink": Style(color="#ff00af", bold=True),
    "cs.hotpink": Style(color="#ff00af", bgcolor="#000000", bold=True),
    "style.hotpink": Style(color="#ff00af", bgcolor="default", bold=True),
    "bg_style.hotpink": Style(color="#000000", bgcolor="#ff00af", bold=True),
    "deeppink": Style(color="#ff1493"),
    "bold.deeppink": Style(color="#ff1493", bold=True),
    "repr.deeppink": Style(color="#ff1493", bold=True),
    "cs.deeppink": Style(color="#ff1493", bgcolor="#000000", bold=True),
    "style.deeppink": Style(color="#ff1493", bgcolor="default", bold=True),
    "bg_style.deeppink": Style(color="#000000", bgcolor="#ff1493", bold=True),
    "red": Style(color="#ff0000"),
    "bold.red": Style(color="#ff0000", bold=True),
    "repr.red": Style(color="#ff0000", bold=True),
    "cs.red": Style(color="#ff0000", bgcolor="#000000", bold=True),
    "style.red": Style(color="#ff0000", bgcolor="default", bold=True),
    "bg_style.red": Style(color="#000000", bgcolor="#ff0000", bold=True),
    "orangered": Style(color="#ff4500"),
    "bold.orangered": Style(color="#ff4500", bold=True),
    "repr.orangered": Style(color="#ff4500", bold=True),
    "cs.orangered": Style(color="#ff4500", bgcolor="#000000", bold=True),
    "style.orangered": Style(color="#ff4500", bgcolor="default", bold=True),
    "bg_style.orangered": Style(color="#000000", bgcolor="#ff4500", bold=True),
    "orange": Style(color="#ffa500"),
    "bold.orange": Style(color="#ffa500", bold=True),
    "repr.orange": Style(color="#ffa500", bold=True),
    "cs.orange": Style(color="#ffa500", bgcolor="#000000", bold=True),
    "style.orange": Style(color="#ffa500", bgcolor="default", bold=True),
    "bg_style.orange": Style(color="#000000", bgcolor="#ffa500", bold=True),
    "yellow": Style(color="#ffff00"),
    "bold.yellow": Style(color="#ffff00", bold=True),
    "repr.yellow": Style(color="#ffff00", bold=True),
    "cs.yellow": Style(color="#ffff00", bgcolor="#000000", bold=True),
    ...
    "cs.greenyellow": Style(color="#adff2f", bgcolor="#000000", bold=True),
    "style.greenyellow": Style(color="#adff2f", bgcolor="default", bold=True),
    "bg_style.greenyellow": Style(color="#000000", bgcolor="#adff2f", bold=True),
    "lawngreen": Style(color="#7cfc00"),
    "bold.lawngreen": Style(color="#7cfc00", bold=True),
    "repr.lawngreen": Style(color="#7cfc00", bold=True),
    "cs.lawngreen": Style(color="#7cfc00", bgcolor="#000000", bold=True),
    "style.lawngreen": Style(color="#7cfc00", bgcolor="default", bold=True),
    "bg_style.lawngreen": Style(color="#000000", bgcolor="#7cfc00", bold=True),
    "lime": Style(color="#00ff00"),
    "bold.lime": Style(color="#00ff00", bold=True),
    "repr.lime": Style(color="#00ff00", bold=True),
    "cs.lime": Style(color="#00ff00", bgcolor="#000000", bold=True),
    "style.lime": Style(color="#00ff00", bgcolor="default", bold=True),
    "bg_style.lime": Style(color="#000000", bgcolor="#00ff00", bold=True),
    "green": Style(color="#008000"),
    "bold.green": Style(color="#008000", bold=True),
    "repr.green": Style(color="#008000", bold=True),
    "cs.green": Style(color="#008000", bgcolor="#000000", bold=True),
    "style.green": Style(color="#008000", bgcolor="default", bold=True),
    "bg_style.green": Style(color="#000000", bgcolor="#008000", bold=True),
    "springgreen": Style(color="#00ff7f"),
    "bold.springgreen": Style(color="#00ff7f", bold=True),
    "repr.springgreen": Style(color="#00ff7f", bold=True),
    "cs.springgreen": Style(color="#00ff7f", bgcolor="#000000", bold=True),
    "style.springgreen": Style(color="#00ff7f", bgcolor="default", bold=True),
    "bg_style.springgreen": Style(color="#000000", bgcolor="#00ff7f", bold=True),
    "cyan": Style(color="#00ffff"),
    "bold.cyan": Style(color="#00ffff", bold=True),
    "repr.cyan": Style(color="#00ffff", bold=True),
    "cs.cyan": Style(color="#00ffff", bgcolor="#000000", bold=True),
    "style.cyan": Style(color="#00ffff", bgcolor="default", bold=True),
    "bg_style.cyan": Style(color="#000000", bgcolor="#00ffff", bold=True),
    "skyblue": Style(color="#87ceeb"),
    "bold.skyblue": Style(color="#87ceeb", bold=True),
    "repr.skyblue": Style(color="#87ceeb", bold=True),
    "cs.skyblue": Style(color="#87ceeb", bgcolor="#000000", bold=True),
    "style.skyblue": Style(color="#87ceeb", bgcolor="default", bold=True),
    "bg_style.skyblue": Style(color="#000000", bgcolor="#87ceeb", bold=True),
    "lightblue": Style(color="#add8e6"),
    "bold.lightblue": Style(color="#add8e6", bold=True),
    "repr.lightblue": Style(color="#add8e6", bold=True),
    "cs.lightblue": Style(color="#add8e6", bgcolor="#000000", bold=True),
    "style.lightblue": Style(color="#add8e6", bgcolor="default", bold=True),
    "bg_style.lightblue": Style(color="#000000", bgcolor="#add8e6", bold=True),
    "blue": Style(color="#0000ff"),
    "bold.blue": Style(color="#0000ff", bold=True),
    "repr.blue": Style(color="#0000ff", bold=True),
    "cs.blue": Style(color="#0000ff", bgcolor="#000000", bold=True),
    "style.blue": Style(color="#0000ff", bgcolor="default", bold=True),
    "bg_style.blue": Style(color="#000000", bgcolor="#0000ff", bold=True),
    "blueviolet": Style(color="#8a2be2"),
    "bold.blueviolet": Style(color="#8a2be2", bold=True),
    "repr.blueviolet": Style(color="#8a2be2", bold=True),
    "cs.blueviolet": Style(color="#8a2be2", bgcolor="#000000", bold=True),
    "style.blueviolet": Style(color="#8a2be2", bgcolor="default", bold=True),
    "bg_style.blueviolet": Style(color="#000000", bgcolor="#8a2be2", bold=True),
    "purple": Style(color="#800080"),
    "bold.purple": Style(color="#800080", bold=True),
    "repr.purple": Style(color="#800080", bold=True),
    "cs.purple": Style(color="#800080", bgcolor="#000000", bold=True),
    "style.purple": Style(color="#800080", bgcolor="default", bold=True),
    "bg_style.purple": Style(color="#000000", bgcolor="#800080", bold=True),
    "violet": Style(color="#ee82ee"),
    "bold.violet": Style(color="#ee82ee", bold=True),
    "repr.violet": Style(color="#ee82ee", bold=True),
    "cs.violet": Style(color="#ee82ee", bgcolor="#000000", bold=True),
    "style.violet": Style(color="#ee82ee", bgcolor="default", bold=True),
    "bg_style.violet": Style(color="#000000", bgcolor="#ee82ee", bold=True),
    "magenta": Style(color="#ff00ff"),
    "bold.magenta": Style(color="#ff00ff", bold=True),
    "repr.magenta": Style(color="#ff00ff", bold=True),
    "cs.magenta": Style(color="#ff00ff", bgcolor="#000000", bold=True),
    ...
    "repr.attrib_value": Style(color="#99ff00", italic=False),
    "repr.number": Style(
...
EDITED_STYLES: Dict[str, str] = {
    ...
    "hotpink": ":paintbrush: [bold #ffffff]Color Corrected[/]",
    "bold.hotpink": ":star: [bold #e1b400]New[/] :star:",
    "repr.hotpink": ":star: [bold #e1b400]New[/] :star:",
    "cs.hotpink": ":star: [bold #e1b400]New[/] :star:",
    "style.hotpink": ":star: [bold #e1b400]New[/] :star:",
    "bg_style.hotpink": ":star: [bold #e1b400]New[/] :star:",
    "deeppink": ":paintbrush: [bold #ffffff]Color Corrected[/]",
    "bold.deeppink": ":star: [bold #e1b400]New[/] :star:",
    "repr.deeppink": ":star: [bold #e1b400]New[/] :star:",
    "cs.deeppink": ":star: [bold #e1b400]New[/] :star:",
    "style.deeppink": ":star: [bold #e1b400]New[/] :star:",
    "bg_style.deeppink": ":star: [bold #e1b400]New[/] :star:",
    ...
    "orangered": ":paintbrush: [bold #ffffff]Color Corrected[/]",
    "bold.orangered": ":star: [bold #e1b400]New[/] :star:",
    "repr.orangered": ":star: [bold #e1b400]New[/] :star:",
    "cs.orangered": ":star: [bold #e1b400]New[/] :star:",
    "style.orangered": ":star: [bold #e1b400]New[/] :star:",
    "bg_style.orangered": ":star: [bold #e1b400]New[/] :star:",
    ...
    "greenyellow": ":paintbrush: [bold #ffffff]Color Corrected[/]",
    "bold.greenyellow": ":star: [bold #e1b400]New[/] :star:",
    "repr.greenyellow": ":star: [bold #e1b400]New[/] :star:",
    "cs.greenyellow": ":star: [bold #e1b400]New[/] :star:",
    "style.greenyellow": ":star: [bold #e1b400]New[/] :star:",
    "bg_style.greenyellow": ":star: [bold #e1b400]New[/] :star:",
    "lawngreen": ":paintbrush: [bold #ffffff]Color Corrected[/]",
    "bold.lawngreen": ":star: [bold #e1b400]New[/] :star:",
    "repr.lawngreen": ":star: [bold #e1b400]New[/] :star:",
    "cs.lawngreen": ":star: [bold #e1b400]New[/] :star:",
    "style.lawngreen": ":star: [bold #e1b400]New[/] :star:",
    "bg_style.lawngreen": ":star: [bold #e1b400]New[/] :star:",
    "lime": ":paintbrush: [bold #ffffff]Color Corrected[/]",
    "bold.lime": ":star: [bold #e1b400]New[/] :star:",
    "repr.lime": ":star: [bold #e1b400]New[/] :star:",
    "cs.lime": ":star: [bold #e1b400]New[/] :star:",
    "style.lime": ":star: [bold #e1b400]New[/] :star:",
    "bg_style.lime": ":star: [bold #e1b400]New[/] :star:",
    ...
    "springgreen": ":paintbrush: [bold #ffffff]Color Corrected[/]",
    "bold.springgreen": ":star: [bold #e1b400]New[/] :star:",
    "repr.springgreen": ":star: [bold #e1b400]New[/] :star:",
    "cs.springgreen": ":star: [bold #e1b400]New[/] :star:",
    "style.springgreen": ":star: [bold #e1b400]New[/] :star:",
    "bg_style.springgreen": ":star: [bold #e1b400]New[/] :star:",
    ...
    "skyblue": ":paintbrush: [bold #ffffff]Color Corrected[/]",
    "bold.skyblue": ":star: [bold #e1b400]New[/] :star:",
    "repr.skyblue": ":star: [bold #e1b400]New[/] :star:",
    "cs.skyblue": ":star: [bold #e1b400]New[/] :star:",
    "style.skyblue": ":star: [bold #e1b400]New[/] :star:",
    "bg_style.skyblue": ":star: [bold #e1b400]New[/] :star:",
    ...
    "blueviolet": ":star: [bold #e1b400]New[/] :star:",
    "bold.blueviolet": ":star: [bold #e1b400]New[/] :star:",
    "repr.blueviolet": ":star: [bold #e1b400]New[/] :star:",
    "cs.blueviolet": ":star: [bold #e1b400]New[/] :star:",
    "style.blueviolet": ":star: [bold #e1b400]New[/] :star:",
    "bg_style.blueviolet": ":star: [bold #e1b400]New[/] :star:",
